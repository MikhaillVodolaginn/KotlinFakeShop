package com.example.kotlinFakeShop.feature_auth.di

import com.example.kotlinFakeShop.core.util.Constants.BASE_URL
...
import com.example.kotlinFakeShop.feature_auth.data.repository.LoginRepositoryImpl
import com.example.kotlinFakeShop.feature_auth.domain.repository.LoginRepository
import com.example.kotlinFakeShop.feature_auth.domain.use_case.AutoLoginUseCase
import com.example.kotlinFakeShop.feature_auth.domain.use_case.LoginUseCase
